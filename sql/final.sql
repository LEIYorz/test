...
--
-- Host: 127.0.0.1
-- Generation Time: 2019-05-04 07:37:28
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
INSERT INTO `seller` (`SID`, `sellername`, `username`, `password`, `SName`, `age`, `telephone`, `address`) VALUES
(1, 'Lae.Smith', 'Lae', 'abc123', '里昂家电旗舰', 24, '15365478857', '广东省珠海市高新区唐家湾镇金凤路6号'),
(2, '雷有智', 'Rae', 'abc123', '雅文数码专卖店', 21, '15916478522', '广东省珠海市香洲区'),
(3, '雷嘉敏', 'Renee', 'abc123', '魅力惠旗舰店', 26, '15916268922', '广东省珠海市高新区唐家湾镇金凤路6号'),
(4, '李浩明', 'ALi', 'abc123', '安源味道食品专卖店', 36, '13536548879', '广东省珠海市香洲区凤凰南路1088号'),
(11, '联想', 'jacky', 'abc123', '钟表世家', 36, '15916268922', '广东省珠海市');
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `balance` float(10,2) DEFAULT '1000000.00',
...
('Jack', 'LoveR1', 1000000.00),
('Renee', 'abc123', 997377.00),
('Rose', 'LoveJ1', 1000000.00),
('test', 'test123', 5000.00);
